...
export const CostStructure = {
    labels: ['PC-4000 дизельный', 'PC-4000 электрический', 'PC-3000 дизельный', 'PC-3000 электрический', 'PC-2000 дизельный', 'PC-2000 электрический', 'PC-1000 дизельный'],
    datasets: [{
            label: 'ИТОГО удельная завтраты на владение в течении 10 лет',
            data: [25.17, 18.51, 25.17, 31.64, 28.07, 20.85, 20.48],
            backgroundColor: '#33538f',
            borderColor: '#33538f',
            type: 'line',
        },
        {
            label: 'Удельные щавтратфы на эксплуатацию экскаваторов',
            data: [8.85, 4.34, 8.20, 7.80, 7.60, 7.42, 7.78, 8.10, 3.20, 3.50, 3.15],
            backgroundColor: '#437db0',
        },
        {
            label: 'Удельные затраты на ФОТ и налоги, руб./м3',
            data: [1.86, 1.44, 1.86, 9.77, 8.75, 3.05, 3.77, 2.14, 3.73, 4.77],
            backgroundColor: '#76a83d',
        },
        {
            label: 'Удельные завтраты на ТО, ТР, Капитальный ремонт, Запасные части, Топливо, Прочее, руб./м3',
            data: [9.35, 6.80, 8.83, 9.19, 8.79, 7.17, 7.17, 7.33, 2.33, 2.19, 1.60],
            backgroundColor: '#ccae53',
        },
        {
            label: 'Удельная стоииость экскаваторов',
            data: [5.11, 5.93, 6.29, 4.44, 1.91, 2.5, 2.48, 2.74, 10.16, 8.99, 6.60],
            backgroundColor: 'rgba(255, 206, 86)',
        },
    ]
}
