      ...
      <div class="flex flex-col gap-y-4">
        <div class="flex justify-between items-center">
          <div class="p-1 bg-[#F2F2F2] inline-flex rounded-2xl">
            <router-link class="py-2 px-4 rounded-2xl text-center text-[#979DAC] font-semibold text-xl leading-5 uppercase"
            ...
            <router-link class="py-2 px-4 rounded-2xl text-center text-[#979DAC] font-semibold text-xl leading-5 uppercase"
              :class="{ 'text-[white] bg-[#0554F2]': $route.query.mode === 'DynamicStructure' }"
              :to="{ name: $route.name, params: { pageName: $route.params.pageName }, query: { mode: 'DynamicStructure' }}">
              вскрыша
            </router-link>
          </div>
          <button class="px-6 py-3 bg-[#0554F2] text-white text-lg font-semibold rounded-lg mr-5 leading-6">Добавить вариант</button>
        </div>
      </div>
      <div class="mt-6">
